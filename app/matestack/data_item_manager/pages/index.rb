class DataItemManager::Pages::Index < Matestack::Ui::Page
  ...
  def data_items_list_partial
    # order_section_partial
    async rerender_on: "uploaded, deleted, data_items_changed", id: "data-item-list" do
  ...
  # Add this if you want to add reactive ordering
  # Don't forget to uncomment the order_section_partial above
